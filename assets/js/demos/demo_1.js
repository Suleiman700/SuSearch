 ...
 * @param _item_value {String} > Example: 1
 * @param _item_text {String} > Example: John Smith
 * @param _item_data {Object} > Example: {id: 1, name: 'John Smith', age: 37}
 */
 ...
 * @param _data {Object} > Example: [{id: 0, name: 'John Smith', age: 37, type: 'male'}, {id: 1, name: 'Hanna Hayner', age: 24, type: 'female'}]
 */
...
SuSearch.set_custom_options('BuildDropdown', {
    ...
    ItemValueAndText: ['code', 'name'] // Code is the item value and name is the item text that will be displayed to the user
})
